            ...
            <div className="flex w-[535px]">
                <div className="flex relative mr-8">
                    <div className="flex relative h-34 w-34 my-auto p-1">
                        ...
                        <svg className="absolute top-5 left-[12.5px]" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-16 h-8 my-auto">
                        <svg width="67" height="30" viewBox="0 0 67 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M28.3528 22.7715H32.8352V10.3403H36.3315V6.45552H32.8352V6.21646C32.8352 4.76217 33.6819 4.03502 35.3752 4.03502C35.6542 4.03502 35.9829 4.0649 36.3614 4.12467V0.299682C35.9032 0.200073 35.3752 0.150269 34.7776 0.150269C32.7456 0.150269 31.1618 0.678196 30.0262 1.73405C28.9106 2.78991 28.3528 4.28404 28.3528 6.21646V6.45552H25.6036V10.3403H28.3528V22.7715Z" fill="black" />
                            <path d="M38.6371 22.7715H43.1195V13.986C43.1195 12.7707 43.4582 11.8344 44.1355 11.177C44.8129 10.4996 45.6994 10.161 46.7951 10.161H48.1996V6.27622H47.2433C46.2473 6.27622 45.3607 6.46548 44.5838 6.84399C43.8268 7.20259 43.2391 7.88989 42.8207 8.9059V6.45552H38.6371V22.7715Z" fill="black" />
